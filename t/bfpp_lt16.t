...
# lt16 - error no arguments
spew("$test.in", "lt16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:5: error: expected '(' after macro name 'lt16'
END

# lt16 - error empty arguments
spew("$test.in", "lt16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:7: error: macro 'lt16' expects 2 arguments
END

# lt16 - error too many arguments
spew("$test.in", "lt16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
