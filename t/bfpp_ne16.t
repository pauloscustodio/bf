...
# ne16 - error no arguments
spew("$test.in", "ne16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:5: error: expected '(' after macro name 'ne16'
END

# ne16 - error empty arguments
spew("$test.in", "ne16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:7: error: macro 'ne16' expects 2 arguments
END

# ne16 - error too many arguments
spew("$test.in", "ne16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
