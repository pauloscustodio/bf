...
# xor16 - error no arguments
spew("$test.in", "xor16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'xor16'
END

# xor16 - error empty arguments
spew("$test.in", "xor16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'xor16' expects 2 arguments
END

# xor16 - error too many arguments
spew("$test.in", "xor16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
...
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  6011 instructions, 15 tape cells
]
[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]<<<<[-]<<<<[->>>>+>>>>+<<<<<<<<]>>>>>>>>[-<<<
<<<<<+>>>>>>>>][-]<<<[-]<<<<[->>>>+>>>+<<<<<<<]>>>>>>>[-<<<<<<<+>>>>>>>][-]>[-]<
[-]<<<<[->>>>+>+<<<<<]>>>>>[-<<<<<+>>>>>][-]>[-]>[-]<<[-]<[->+<]>>>>[-]>[-]<[-]<
