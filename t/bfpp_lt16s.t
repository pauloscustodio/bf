...
# lt16s - error no arguments
spew("$test.in", "lt16s");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'lt16s'
END

# lt16s - error empty arguments
spew("$test.in", "lt16s()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'lt16s' expects 2 arguments
END

# lt16s - error too many arguments
spew("$test.in", "lt16s(A,B,C)");
capture_nok("bfpp $test.in", <<END);
