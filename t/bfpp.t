...
spew("$test.in", <<'END'); # Note: quoted 'END' because of $
alloc_cell8(A$)
>A$ ++
END
capture_ok("bfpp $test.in", <<END);
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  5 instructions, 1 tape cells
]
[-]++
END
