...
# sub16s - error no arguments
spew("$test.in", "sub16s");
capture_nok("bfpp $test.in", <<END);
$test.in:1:7: error: expected '(' after macro name 'sub16s'
END

# sub16s - error empty arguments
spew("$test.in", "sub16s()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:9: error: macro 'sub16s' expects 2 arguments
END

# sub16s - error too many arguments
spew("$test.in", "sub16s(A,B,C)");
capture_nok("bfpp $test.in", <<END);
