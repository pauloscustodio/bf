...
# max16 - error no arguments
spew("$test.in", "max16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'max16'
END

# max16 - error empty arguments
spew("$test.in", "max16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'max16' expects 2 arguments
END

# max16 - error too many arguments
spew("$test.in", "max16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
