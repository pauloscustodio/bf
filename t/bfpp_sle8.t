...
# sle8 - error no arguments
spew("$test.in", "sle8");
capture_nok("bfpp $test.in", <<END);
$test.in:1:5: error: expected '(' after macro name 'sle8'
END

# sle8 - error empty arguments
spew("$test.in", "sle8()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:7: error: macro 'sle8' expects 2 arguments
END

# sle8 - error too many arguments
spew("$test.in", "sle8(A,B,C)");
capture_nok("bfpp $test.in", <<END);
