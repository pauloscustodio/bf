...
# min16s - error no arguments
spew("$test.in", "min16s");
capture_nok("bfpp $test.in", <<END);
$test.in:1:7: error: expected '(' after macro name 'min16s'
END

# min16s - error empty arguments
spew("$test.in", "min16s()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:9: error: macro 'min16s' expects 2 arguments
END

# min16s - error too many arguments
spew("$test.in", "min16s(A,B,C)");
capture_nok("bfpp $test.in", <<END);
...
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  24784 instructions, 28 tape cells
]
[-]>[-]>[-]>[-]>[-]>[-]>[-]<<[-]<<<<[->>>>+>>+<<<<<<]>>>>>>[-<<<<<<+>>>>>>][-]<[
-]<<<<[->>>>+>+<<<<<]>>>>>[-<<<<<+>>>>>][-]>[-]>[-]>[-]>[-]>[-]>[-]<<<<<<[-]>[-]
<<<[->>>+<+<<]>>[-<<+>>][-]>>[-]<<<[->>>+<<+<]>[-<+>][-]>>>>>>>[-]>[-]<[-]>[-]++
