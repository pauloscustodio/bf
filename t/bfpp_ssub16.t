...
# ssub16 - error no arguments
spew("$test.in", "ssub16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:7: error: expected '(' after macro name 'ssub16'
END

# ssub16 - error empty arguments
spew("$test.in", "ssub16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:9: error: macro 'ssub16' expects 2 arguments
END

# ssub16 - error too many arguments
spew("$test.in", "ssub16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
