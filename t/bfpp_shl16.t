...
# shl16 - error no arguments
spew("$test.in", "shl16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'shl16'
END

# shl16 - error empty arguments
spew("$test.in", "shl16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'shl16' expects 2 arguments
END

# shl16 - error too many arguments
spew("$test.in", "shl16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
...
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  2497 instructions, 20 tape cells
]
[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]<<[-]<<<<[->>>>+>>+<<<<<<]>>>>>>[-<<<<<<+>>>>
>>][-]<[-]<<<<[->>>>+>+<<<<<]>>>>>[-<<<<<+>>>>>][-]<<[>>[-]<<<<[-]<<<<[->>>>+>>>
>+<<<<<<<<]>>>>>>>>[-<<<<<<<<+>>>>>>>>][-]<<<[-]<<<<[->>>>+>>>+<<<<<<<]>>>>>>>[-
