...
# sne16 - error no arguments
spew("$test.in", "sne16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'sne16'
END

# sne16 - error empty arguments
spew("$test.in", "sne16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'sne16' expects 2 arguments
END

# sne16 - error too many arguments
spew("$test.in", "sne16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
