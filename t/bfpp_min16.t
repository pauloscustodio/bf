...
# min16 - error no arguments
spew("$test.in", "min16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'min16'
END

# min16 - error empty arguments
spew("$test.in", "min16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'min16' expects 2 arguments
END

# min16 - error too many arguments
spew("$test.in", "min16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
...
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  4792 instructions, 20 tape cells
]
[-]>[-]>[-]>[-]>[-]>[-]>[-]<<[-]<<<<[->>>>+>>+<<<<<<]>>>>>>[-<<<<<<+>>>>>>][-]<[
-]<<<<[->>>>+>+<<<<<]>>>>>[-<<<<<+>>>>>][-]>[-]>[-]<<[-]<[->+>>+<<<]>>>[-<<<+>>>
][-]>[-]>[-]>[-]>[-]<<<<[-]<<[->>+>>>>+<<<<<<]>>>>>>[-<<<<<<+>>>>>>][-]<<<[-]<<<
