...
# sadd16 - error no arguments
spew("$test.in", "sadd16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:7: error: expected '(' after macro name 'sadd16'
END

# sadd16 - error empty arguments
spew("$test.in", "sadd16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:9: error: macro 'sadd16' expects 2 arguments
END

# sadd16 - error too many arguments
spew("$test.in", "sadd16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
