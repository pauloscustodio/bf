...
# le16s - error no arguments
spew("$test.in", "le16s");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'le16s'
END

# le16s - error empty arguments
spew("$test.in", "le16s()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'le16s' expects 2 arguments
END

# le16s - error too many arguments
spew("$test.in", "le16s(A,B,C)");
capture_nok("bfpp $test.in", <<END);
...
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  23251 instructions, 26 tape cells
]
[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]<<<<<<[-]<<<<[->>>>+>>>>>>+<<<<<<<<<<
]>>>>>>>>>>[-<<<<<<<<<<+>>>>>>>>>>][-]<<<<<[-]<<<<[->>>>+>>>>>+<<<<<<<<<]>>>>>>>
>>[-<<<<<<<<<+>>>>>>>>>][-]>[-]>[-]<[-]>[-]+++++++++++++++++++++++++++++++++++++
