...
# sle16 - error no arguments
spew("$test.in", "sle16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'sle16'
END

# sle16 - error empty arguments
spew("$test.in", "sle16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'sle16' expects 2 arguments
END

# sle16 - error too many arguments
spew("$test.in", "sle16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
