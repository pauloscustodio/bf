...
# seq16 - error no arguments
spew("$test.in", "seq16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'seq16'
END

# seq16 - error empty arguments
spew("$test.in", "seq16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'seq16' expects 2 arguments
END

# seq16 - error too many arguments
spew("$test.in", "seq16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
