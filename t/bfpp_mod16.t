...
# mod16 - error no arguments
spew("$test.in", "mod16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'mod16'
END

# mod16 - error empty arguments
spew("$test.in", "mod16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'mod16' expects 2 arguments
END

# mod16 - error too many arguments
spew("$test.in", "mod16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
...
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  62577 instructions, 40 tape cells
]
[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]<
[-]+>[-]>[-]<<<<<<[-]<<<<<<<<<<<<[->>>>>>>>>>>>+>>>>>>+<<<<<<<<<<<<<<<<<<]>>>>>>
>>>>>>>>>>>>[-<<<<<<<<<<<<<<<<<<+>>>>>>>>>>>>>>>>>>][-]<<<<<[-]<<<<<<<<<<<<[->>>
