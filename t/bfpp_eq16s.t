...
# eq16s - error no arguments
spew("$test.in", "eq16s");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'eq16s'
END

# eq16s - error empty arguments
spew("$test.in", "eq16s()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'eq16s' expects 2 arguments
END

# eq16s - error too many arguments
spew("$test.in", "eq16s(A,B,C)");
capture_nok("bfpp $test.in", <<END);
...
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  902 instructions, 11 tape cells
]
[-]>[-]>[-]>[-]>[-]>[-]>[-]<<[-]<<<<[->>>>+>>+<<<<<<]>>>>>>[-<<<<<<+>>>>>>][-]>[
-]<[-]<<<<[->>>>+>+<<<<<]>>>>>[-<<<<<+>>>>>][-]<[-<<->>][-]>[-]<[-]<<[->>+<<]+>>
>+<[->[-<<<->>>]<][-]>[-]<[-]<[-]<<<<[->>>>+>+<<<<<]>>>>>[-<<<<<+>>>>>][-]>[-]<[
