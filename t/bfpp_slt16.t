...
# slt16 - error no arguments
spew("$test.in", "slt16");
capture_nok("bfpp $test.in", <<END);
$test.in:1:6: error: expected '(' after macro name 'slt16'
END

# slt16 - error empty arguments
spew("$test.in", "slt16()");
capture_nok("bfpp $test.in", <<END);
$test.in:1:8: error: macro 'slt16' expects 2 arguments
END

# slt16 - error too many arguments
spew("$test.in", "slt16(A,B,C)");
capture_nok("bfpp $test.in", <<END);
...
[ Generated by bfpp, see https://github.com/pauloscustodio/bf
  22355 instructions, 26 tape cells
]
[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]>[-]<<<<<<[-]<<<<[->>>>+>>>>>>+<<<<<<<<<<
]>>>>>>>>>>[-<<<<<<<<<<+>>>>>>>>>>][-]<<<<<[-]<<<<[->>>>+>>>>>+<<<<<<<<<]>>>>>>>
>>[-<<<<<<<<<+>>>>>>>>>][-]>[-]>[-]<[-]>[-]+++++++++++++++++++++++++++++++++++++
